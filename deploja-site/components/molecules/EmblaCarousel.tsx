  ...
  return (
    ...
    >
      ...
      <img
        ...
        className={`w-24 lg:w-32 h-24 lg:h-32 ml-4 lg:ml-24 absolute left-0 top-[unset] sm:top-1/2 bottom-0 sm:bottom-[unset] transform -translate-y-1/4 ${
      ...
      <img
        ...
        className={`w-24 lg:w-32 h-24 lg:h-32 mr-4 lg:mr-24 absolute right-0 top-[unset] sm:top-1/2 bottom-0 sm:bottom-[unset] transform -translate-y-1/4 ${
